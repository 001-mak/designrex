...
function ToolbarProperties() {
  const { textProps,setTextProps, setShowTextProp, transformerRef, indexRef, currentEventRef, texts, setTexts} = useDesignContext();
  ...
  return (
    <div className="d-flex align-items-center">
                        ...
                        <MdDelete
                          ...
                          onClick={() => {
                            const updatedTexts = texts.filter(text => text.id !== textProps.id);
