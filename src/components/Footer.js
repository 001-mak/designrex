        ...
        <div className="container">
          <div className="row gy-5">
            ...
            <div className="col-lg-4">
              <h5 className="text-white footer-title-01 fs-5">Subscribe to our newsletter and get 15% off your next order.</h5>
              <div>
                <form className="d-flex flex-row mb-2 p-1 bg-white input-group"><input type="email" className="form-control rounded border-0" placeholder="Your Email" /> <button className="btn btn-secondary flex-shrink-0" type="submit">Subscribe</button></form>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-6 text-center text-md-start py-1">
              <p className="m-0 text-white text-opacity-75">© 2024 copyright by <a className="text-reset" href="#">DesignRex</a></p>
            </div>
            <div className="col-md-6 text-center text-md-end py-1">
              <ul className="nav justify-content-center justify-content-md-end list-unstyled footer-link-01 m-0">
                <li className="p-0 mx-3 ms-md-0 me-md-3"><a href="#" className="text-white text-opacity-75">Privace &amp; Policy</a></li>
                <li className="p-0 mx-3 ms-md-0 me-md-3"><a href="#" className="text-white text-opacity-75">Faq's</a></li>
                <li className="p-0 mx-3 ms-md-0 me-md-3"><a href="#" className="text-white text-opacity-75">Contact Us</a></li>
              </ul>
            </div>
          </div>
        </div>
